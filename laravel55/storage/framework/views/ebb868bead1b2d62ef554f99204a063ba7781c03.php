<?php $__env->startSection('content'); ?>
    <el-tabs type="border-card" value="<?php echo e($tab); ?>">
        
        <?php echo $__env->make('laravel-generator::generator', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        
        <?php echo $__env->make('laravel-generator::generator_migrate', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        
        <?php echo $__env->make('laravel-generator::template_lists', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    </el-tabs>
        ...
        var vm =new Vue({
            ...
            data:{
                ...
                ruleForm: {
                    ...
                    //选中的模板数据
                    templates:{
                        <?php $__currentLoopData = $template_types['datas']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $templates): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        '<?php echo e($templates['name']); ?>':@json($templates['checked']),
                ...
                rules: {
                    prefix: [
                        { required: true, message: 'prefix <?php echo app('translator')->getFromJson('laravel-generator::generator.required'); ?>', trigger: 'blur' },
                    ],
                    modelName: [
                        { required: true, message: 'model <?php echo app('translator')->getFromJson('laravel-generator::generator.required'); ?>', trigger: 'blur' },
                    ],
                    modelDisplayName: [
                        { required: true, message: '<?php echo app('translator')->getFromJson('laravel-generator::generator.displayName'); ?> <?php echo app('translator')->getFromJson('laravel-generator::generator.required'); ?>', trigger: 'blur' },
                    ],
                    tableName: [
                        { required: true, message: 'table name <?php echo app('translator')->getFromJson('laravel-generator::generator.required'); ?>', trigger: 'blur' },
                    ],
                }
            },
            computed: {
            ...
            watch:{
                ...
                'ruleForm.modelName': function(val){
                   if(val){
                       ...
                       var route='<?php echo e(route('generator.dummyValues',['name'=>''])); ?>'+'/'+this.ruleForm.modelName;
                       //获取请求的数据
            ...
            methods:{
                ...
                async getDummyValues(model){
                    var route='<?php echo e(route('generator.dummyValues',['name'=>''])); ?>'+'/'+model;
                ...
                //获取模板列表数据
                getData(){
                    axios.get('<?php echo e(route('generator.template.index')); ?>',{params:this.search}).then(function (res) {
                        var data=res.data;
                        if(data.errcode==0){
                ...
                //删除模板
                deleteTemplate(id){
                    this.$confirm('<?php echo app('translator')->getFromJson('laravel-generator::generator.confirmDelete'); ?>', '<?php echo app('translator')->getFromJson('laravel-generator::generator.notice'); ?>', {
                        confirmButtonText: '<?php echo app('translator')->getFromJson('laravel-generator::generator.sure'); ?>',
                        cancelButtonText: '<?php echo app('translator')->getFromJson('laravel-generator::generator.cancel'); ?>',
                        type: 'warning'
                    }).then(() => {
                            axios.post('<?php echo e(route('generator.template.delete')); ?>',{id:id}).then(function (res) {
                                if(res.data.errcode==0){
                                    var href='<?php echo e(route('generator.index')); ?>?tab=templates'
                ...
                submitForm(formName) {
                    this.$refs[formName].validate((valid) => {
                        if (valid) {
                            ...
                            this.loadding=true;
                            axios.post('<?php echo e(\Illuminate\Support\Facades\URL::current()); ?>',this.ruleForm).then(function(res){
                                if(res.data.errcode==0){
                ...
                submitMigrateForm(migrateForm) {
                    this.$refs[migrateForm].validate((valid) => {
                        if (valid) {
                            this.loadding=true;
                            axios.post('<?php echo e(\Illuminate\Support\Facades\URL::current()); ?>',this.migrateForm).then(function(res){
                                if(res.data.errcode==0){
                                    var data=res.data.data;
                                    var message='';
                                    for(x in data){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('laravel-generator::layout', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>