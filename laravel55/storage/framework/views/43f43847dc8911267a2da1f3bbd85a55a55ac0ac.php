<el-tab-pane>
    ...
    <el-form label-position="top" :model="ruleForm"  status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
        ...
        <el-form-item label="<?php echo app('translator')->getFromJson('laravel-generator::generator.displayName'); ?>" prop="modelDisplayName" style="margin-bottom: 5px">
            <el-popover placement="top-start" trigger="hover" >
                <p><?php echo app('translator')->getFromJson('laravel-generator::generator.modelDisplayNameDesc'); ?></p>
        ...
        <el-form-item label="table fileds">
            <el-row >
                <el-col :span="2">
                    <el-popover placement="top-start" trigger="hover" >
                        <p><?php echo app('translator')->getFromJson('laravel-generator::generator.fieldName'); ?></p>
                        <span slot="reference">Field name<i class="el-icon-question"></i></span>
                    </el-popover>
                </el-col>
                <el-col :span="2" style="margin-left: 10px">
                    <el-popover placement="top-start" trigger="hover">
                        <p><?php echo app('translator')->getFromJson('laravel-generator::generator.displayNameDesc'); ?></p>
                        <span slot="reference"><?php echo app('translator')->getFromJson('laravel-generator::generator.displayName'); ?><i class="el-icon-question"></i></span>
                    </el-popover>
                </el-col>
                <el-col :span="2"style="margin-left: 10px">Type</el-col>
                <el-col :span="2" style="margin-left: 10px">
                    <el-popover placement="top-start" trigger="hover">
                        <p><?php echo app('translator')->getFromJson('laravel-generator::generator.youNeed'); ?><el-tag type="success">$table->decimal('amount', 5, 2)</el-tag>,<?php echo app('translator')->getFromJson('laravel-generator::generator.soAttach'); ?></p>
                ...
                <el-col :span="1" style="width: 80px">
                    <el-popover placement="top-start" trigger="hover">
                        <p><?php echo app('translator')->getFromJson('laravel-generator::generator.showListsDesc'); ?></p>
                        <span slot="reference"><?php echo app('translator')->getFromJson('laravel-generator::generator.showLists'); ?><i class="el-icon-question"></i></span>
                    </el-popover>
                </el-col>
                <el-col :span="1" style="width: 80px">
                    <el-popover placement="top-start" trigger="hover">
                        <p><?php echo app('translator')->getFromJson('laravel-generator::generator.canSearchDesc'); ?></p>
                        <span slot="reference"><?php echo app('translator')->getFromJson('laravel-generator::generator.canSearch'); ?><i class="el-icon-question"></i></span>
                    </el-popover>
                </el-col>
            ...
            <el-row v-for="(table,index) in ruleForm.table_fields" style="margin-bottom: 20px">
                ...
                <el-col :span="2" style="margin-left: 10px">
                    <el-input v-model="table.field_display_name" placeholder="<?php echo app('translator')->getFromJson('laravel-generator::generator.displayName'); ?>"></el-input>
                </el-col>
                <el-col :span="2" style="margin-left: 10px">
        ...
        <el-form-item>
            <el-button type="danger" @click="addForeign" icon="el-icon-plus"><?php echo app('translator')->getFromJson('laravel-generator::generator.add'); ?> <?php echo app('translator')->getFromJson('laravel-generator::generator.foreign'); ?></el-button>
        </el-form-item>
            ...
            <el-row v-for="(foreign,index) in ruleForm.foreigns" style="margin-bottom: 20px">
                <el-col :span="2">
                    <el-select v-model="foreign.foreign" placeholder="foreign"
                               no-data-text="<?php echo app('translator')->getFromJson('laravel-generator::generator.noData'); ?>">
                        <el-option
        ...
        <el-form-item>
            <el-button type="warning" icon="el-icon-star-off"  @click="addRelationship"><?php echo app('translator')->getFromJson('laravel-generator::generator.add'); ?> <?php echo app('translator')->getFromJson('laravel-generator::generator.relationship'); ?></el-button>
        </el-form-item>
